...
#define ABOUT_VALUE_TEXT1 @"Основа нашего коуч календаря - это определение ваших ценностей и осознанное применение  их в вашей жизни. Перед тем как начать пользоваться приложением, необходимо определить свои ценности. Выберите, пожалуйста, от 7 до 11 ценностей из предложенного списка либо добавьте  свои."
...
#define ABOUT_VALUE_TEXT4 @"Реализуя свои ценности в течение своей жизни, мы можем ощущать, что живем свою жизнь и именно ты являешься директором своей жизни!"
